...
# Filter for the one I just generated
...
seed_and_residual_idx = codes.index("USDAGOO.SOYBEANSDP.SEEDANDRESIDUAL.A")
...
for i, year in enumerate(years):
    ...
    seed_and_residual_val = df.iloc[row_idx, seed_and_residual_idx]
    biodiesel_val = df.iloc[row_idx, biodiesel_idx]
    print(f"Year {year}: Seed={seed_val}, Residual={residual_val}, S&R={seed_and_residual_val}, Biodiesel={biodiesel_val}")
